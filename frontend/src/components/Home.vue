    ...
    <div class="container-proj q-my-xl">
      ...
      <div class="row">
        <div class="col">
          ...
          <div class="col-sm-9 col-12 text-body1">
            <b>Disciplina:</b> Oficina de Projeto de Sistemas de Informação para
            WEB
          </div>
          <div class="col-sm-9 col-12 text-body1">
        ...
        <div class="col">
          ...
          <div class="col-sm-9 col-12 text-body1">
            Desenvolver um sistema para um PetShop que atenda pelo menos três
            requisitos de sistema.
          </div>
          <div class="col-sm-9 col-12 text-body1">
            O sistema deve permitir adicionar consultas que são guardadas em um
            histórico.
          </div>
        </div>
      </div>
